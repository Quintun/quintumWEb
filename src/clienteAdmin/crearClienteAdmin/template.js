          ...
          <div id = "containerTipo1Interno" class="container z-depth-4 ">
            ...
            <div class="row">
              <div id = "usernameCol" class="input-field col s10  m8 l6 offset-s1 offset-m2 offset-l3">
               <input id="crearClienteNombre" type="text" class="validate ">
               <label for="first_name">Nombre</label>
              </div>
            </div>
            <div class="row">
              <div id = "usernameCol" class="input-field col s10  m8 l6 offset-s1 offset-m2 offset-l3">
               <input id="crearClienteRut" type="text" class="validate ">
               <label for="first_name">Rut</label>
              </div>
            </div>
            <div class="row">
              <div id = "usernameCol" class="input-field col s10  m8 l6 offset-s1 offset-m2 offset-l3">
               <input id="crearClienteDescrip" type="text" class="validate" >
               <label for="first_name">Descripción</label>
              </div>
            </div>
            <div class="row">
              <div id = "usernameCol" class="input-field col s10  m8 l6 offset-s1 offset-m2 offset-l3">
               <input id="crearClienteDireccion" type="text" class="validate ">
